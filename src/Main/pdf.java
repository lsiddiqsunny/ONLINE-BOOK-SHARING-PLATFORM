...
public class pdf {
    ...
    private static void addTitlePage(Document document,String name,ArrayList<orderinfo> Item )
        ...
        // Will create: Report generated by: _name, _date
        preface.add(new Paragraph(
                "Purchase report generated on: " +  new Date(),
                smallBold));
        ...
        c1 = new PdfPCell(new Phrase("Price(With Discount)"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
        ...
        for(orderinfo e:Item) {
            ...
            int x=Integer.parseInt(cartutil.getorderoffer(e.getOrderid()));
            System.out.println(x);
            table.addCell(String .valueOf(Double.parseDouble(e.getAmount())*x*.01*Double.parseDouble( bookutil.getBookPrice(bookutil.getBookid(e.getBookname()))))+" /-");
        i++;
        sum+=Double.parseDouble(e.getAmount())*x*.01*Double.parseDouble( bookutil.getBookPrice(bookutil.getBookid(e.getBookname())));
        }
