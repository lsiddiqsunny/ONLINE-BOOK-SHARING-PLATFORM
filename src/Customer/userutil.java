...
public class userutil {
    ...
    {
        String sql = "select notification_id,notification_massage,notification_time from NOTIFICATION where notifiedtocustomer=? and status=1";
    ...
    public static void updatenotistatus(String id)
    {
        String sql = "update notification set status=2 where notification_id=?";
